...
const DayWeekView = ({day, handleClick, eventsInCurrentWeek, status}) => {
    return (
        <div className={"day position" + day.format('d')}>
            ...
            <div className="day-post">
                <EventsWeekView key={'day' + day.id} day={day} eventsInCurrentWeek={eventsInCurrentWeek} handleClick={handleClick} status={status}/>
            </div>
        </div>
    )
}
